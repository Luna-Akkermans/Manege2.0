...
define('DB_NAME', 'ridingschool'); // Wat is de database naam
...
define('DEFAULT_CONTROLLER', 'Content'); 			// Dit is de standaard controller waarmee de webapplictie wordt opgestart
